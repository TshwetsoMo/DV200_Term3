        ...
        <div className={style.main}>
            <Nav className={style.tabHolder}>
                <div className={style.tab}>
                    <NavLink href="./Pages/landing.js"><h2>home</h2></NavLink>
                </div>
                <div className={[style.tab, style.tabText].join(' ')}>
                    <NavLink href="./Pages/products.js"><h2>merchandise</h2></NavLink>
                </div>
                <div className={[style.tab, style.tabText].join(' ')}>
                    <NavLink href="./Components/cart.js"><h2>cart</h2></NavLink>
                </div>
                <div className={[style.tab, style.tabText].join(' ')}>
                    <NavLink href="./Pages/checkout.js"><h2>checkout</h2></NavLink>
                </div>
                <div className={[style.tab, style.tabText].join(' ')}>
                    <NavLink href="./Pages/login.js"><h2>logout</h2></NavLink>
                </div>
